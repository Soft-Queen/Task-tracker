  ...
  return isOpen ? (
    <div className="modal">
      <div className="modal-content">
        ...
        <button className='btn btn-info' onClick={handleSave} disabled={title === '' || description === '' || selectedPriority === '' || endDate === ''}>save</button>
        <button className='btn btn-sm btn-danger close-button' onClick={onClose}>close</button>
      </div>
    </div>
  ) : null;
};
